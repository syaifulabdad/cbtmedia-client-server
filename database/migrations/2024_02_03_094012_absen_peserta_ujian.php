...
return new class extends Migration {
    ...
    {
        Schema::create('absen_peserta_ujian', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('status')->default("H")->index(); // H: hadir, S: sakit, I:izin, A: alpa
    ...
    {
        Schema::dropIfExists('absen_peserta_ujian');
    }
};
